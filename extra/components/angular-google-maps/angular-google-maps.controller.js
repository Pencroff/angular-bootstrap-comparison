...
(function(angular) {
    ...
    angular
        ...
        .config(GoogleMapApiProvider)
        .run(GoogleMapApiRun)
        .controller('controlController', ControlController)
        .controller('AngularGoogleMapCtrl', AngularGoogleMapCtrl)
        .controller('InfoController', InfoController);

    GoogleMapApiProvider.$inject = ['uiGmapGoogleMapApiProvider'];

    function GoogleMapApiProvider (GoogleMapApi) {
...
//    key: 'your api key',
    ...
    GoogleMapApiRun.$inject = ['$templateCache'];

    function GoogleMapApiRun ($templateCache) {
    ...
    ControlController.$inject = ['$scope'];

    function ControlController ($scope) {
    ...
    AngularGoogleMapCtrl.$inject = ['$scope', '$timeout', 'uiGmapLogger', '$http', 'rndAddToLatLon','uiGmapGoogleMapApi'];

    function AngularGoogleMapCtrl($scope, $timeout, $log, $http, rndAddToLatLon, GoogleMapApi) {
        ...
        //    $scope.version = '2.1.5' //data.version;
        //});
...
//        blacklist: ['drag', 'dragend','dragstart','zoom_changed', 'center_changed'],
    ...
    InfoController.$inject = ['$scope', '$log'];
